...
<table class="cbi_width100" cellpadding="0" cellspacing="0">
    <tbody>
        <tr>
            <td colspan="1" class="cbi_width15 cbi_texttop">
        ...
        <tr>
            ...
            <td class="cbi_texttop">
                <?php $metabox->the_field('sdate'); ?>
                <input type="date" id="sdatepicker" name="<?php $metabox->the_name(); ?>" value="<?php $metabox->the_value(); ?>" class="cbi_width50 cbi_field"/>
            </td>
            <td class="cbi_width15 cbi_texttop">
                <label>Start Time</label>
            </td>
            <td class="cbi_texttop">
                <?php $metabox->the_field('stime'); ?>
                <input type="time" name="<?php $metabox->the_name(); ?>" value="<?php $metabox->the_value(); ?>" class="cbi_width50 cbi_field"/>
            </td>
        </tr>
        <tr>
            <td class="cbi_width15 cbi_texttop">
            ...
            <td class="cbi_texttop">
                <?php $metabox->the_field('edate'); ?>
                <input type="date" id="edatepicker" name="<?php $metabox->the_name(); ?>" value="<?php $metabox->the_value(); ?>" class="cbi_width50 cbi_field"/>
            </td>
            <td class="cbi_width15 cbi_texttop">
                <label>End Time</label>
            </td>
            <td class="cbi_texttop">
                <?php $metabox->the_field('etime'); ?>
                <input type="time" name="<?php $metabox->the_name(); ?>" value="<?php $metabox->the_value(); ?>" class="cbi_width50 cbi_field"/>
            </td>
        </tr>
        <tr>
